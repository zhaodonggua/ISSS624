...
Use 4 datasets to create interactive map. ::: panel-tabset
...
### Weekend/Holiday Morning vs. Afternoon Peak

The downtown region has a distinct centralization of passenger trips. This center zone is most likely a major commercial or leisure sector that draws people even on weekends and holidays. The geographic distribution appears less concentrated on weekends/holidays than on weekdays, with more activity in outskirts and residential regions, indicating the non-work nature of travels.
